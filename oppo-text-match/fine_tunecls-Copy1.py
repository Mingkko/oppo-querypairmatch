...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_score > self.best_val_score:
            ...
            model.save_weights('./pretrain_model/nezha2/finetune/0408cls_predq2q1nezhasingle.weights')
...
if __name__ == '__main__':
    ...
    model.load_weights('./pretrain_model/nezha2/finetune/0408cls_predq2q1nezhasingle.weights')
    predict_to_file('0408cls_bigramnezha_adv_10epoch_single.csv')
