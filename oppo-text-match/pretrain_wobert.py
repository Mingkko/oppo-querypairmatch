...
maxlen = 32
batch_size = 64
config_path = '/share/lichongyang/code/qamatch/oppo-text-match/pretrain_model/chinese_wobert_L-12_H-768_A-12/originmodel/bert_config.json'
checkpoint_path = '/share/lichongyang/code/qamatch/oppo-text-match/pretrain_model/chinese_wobert_L-12_H-768_A-12/originmodel/bert_model.ckpt'
dict_path = '/share/lichongyang/code/qamatch/oppo-text-match/pretrain_model/chinese_wobert_L-12_H-768_A-12/originmodel/vocab.txt'
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_score > self.best_val_score:
            ...
            model.save_weights('./pretrain_model/chinese_wobert_L-12_H-768_A-12/q2q1wobert.weights')
        print(
...
if __name__ == '__main__':
    ...
    model.load_weights('./pretrain_model/chinese_wobert_L-12_H-768_A-12/q2q1wobert.weights')
